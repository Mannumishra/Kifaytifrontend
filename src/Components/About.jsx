                    ...
                    <div className="row g-4">
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div className="d-flex py-5 px-4">
                                ...
                                <div className="ps-4">
                                    <h5 className="mb-3">Quality Product</h5>
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div className="d-flex bg-light py-5 px-4">
                                ...
                                <div className="ps-4">
                                    <h5 className="mb-3">Gaurantee Product</h5>
                                    <p>Diam dolor diam ipsum sit amet diam et eos erat ipsum</p>
                                    <a className="text-secondary border-bottom" href="">Read More</a>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div className="d-flex py-5 px-4">
                                ...
                                <div className="ps-4">
                                    <h5 className="mb-3">Modern Product</h5>
                                    <p>Diam dolor diam ipsum sit amet diam et eos erat ipsum</p>
                                    <a className="text-secondary border-bottom" href="">Read More</a>
                                </div>
                            </div>
                    ...
                    <div className="row g-5">
                        <div className="col-lg-6 pt-4" style={{ minHeight: "400px" }}>
                            <div className="position-relative h-100 wow fadeIn" data-wow-delay="0.1s">
                                <img className="position-absolute img-fluid w-100 h-100" src="img/1496239.jpg" style={{ objectFit: "cover" }} alt="" />
                        ...
                        <div className="col-lg-6">
                            ...
                            <h1 className="mb-4"><span className="text-primary">The eCommerce</span> Is The Best Plateform for online Shopping</h1>
                            ...
                            <div className="row g-4 mb-3 pb-3">
                                <div className="col-12 wow fadeIn" data-wow-delay="0.1s">
                                    <div className="d-flex">
                                        ...
                                        <div className="ps-3">
                                            <h6>Professional & Expert Delevery</h6>
