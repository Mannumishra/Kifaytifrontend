...
export default function Profile() {
    ...
    function deleteItem(_id) {
        if(window.confirm("Are You Sure to Delete that Item from Wishlist: ")){
    ...
    return (
        <>
            ...
            <div className="row">
                ...
                <h5 className='text-center bg-primary text-light p-2'>Orders Section</h5>
                {
                    orders.length ?
                        <>
                            {
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{item.paymentstatus}
                                                                <br />
                                                                {item.paymentmode!=="COD" && item.paymentstatus==="Pending"?<Link to={`/payment/${item._id}`} className='btn btn-primary'>Pay Now</Link>:""}    
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>Subtotal</th>
