                ...
                <div className="row gx-0 d-none d-lg-flex">
                    <div className="col-lg-4 px-5 text-start">
                        <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                            ...
                            <small>A-268, Vijay Vihar Ph-1 , Rohini Delhi ,India</small>
                        </div>
                    </div>
                    <div className="col-lg-8 px-5 text-end">
                        <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                            <small className="fa fa-phone-alt text-primary me-2"></small>
                            <small><Link to="tel:9354757842">+91-9354757842</Link></small>
                        </div>
                        <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                            <small className="fa fa-envelope text-primary me-2"></small>
                            <small><Link to="mailto:mannu22072000@gmail.com">mannu22072000@gmail.com</Link></small>
                        </div>
